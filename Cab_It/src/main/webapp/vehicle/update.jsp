    ...
    <body>
        ...
        <div class="container">
			...
			<div class="main-container">
				<form action="/Cab_It/validation/vehicle/update-validation.jsp" method="POST">
		            <label for=" ">Model</label>
		            <input
		                    type="text"
		                    name="model"
		                    value=<%= session.getAttribute("prev-model") == null ? vehicle.getModel() : session.getAttribute("prev-model") %>>
		                    <font color="red">
		            ...
		            <input
		                    type="text"
		                    name="brand"
		                    value=<%= session.getAttribute("prev-brand") == null ? vehicle.getBrand() : session.getAttribute("prev-brand") %>>
		                    <font color="red">
		           ...
		           <label for=""> Fuel type </label>
		            <input
		                    type="text"
		                    name="fuel-type"
		                    value=<%= session.getAttribute("prev-fuel-type") == null ? vehicle.getFuelType() : session.getAttribute("prev-fuel-type") %>>
		            <br>
		            ...
		            <input
		                    type="text"
		                    name="engine-type"
		                    value=<%= session.getAttribute("prev-engine-type") == null ? vehicle.getEngineType() : session.getAttribute("prev-engine-type") %>>
		            <br>
		            ...
		            <input
		                    type="text"
		                    name="plate-number"
		                    value=<%= session.getAttribute("prev-plate-number") == null ? vehicle.getPlateNumber() : session.getAttribute("prev-plate-number") %>>
		                    <font color="red">
		            ...
		            <input
		                    type="text"
		                    name="top-speed"
		                    value=<%= session.getAttribute("prev-top-speed") == null ? vehicle.getTopSpeed() : session.getAttribute("prev-top-speed") %>>
		                    <font color="red">
