...
<html>
	...
	<head>
	   <meta charset="UTF-8">
	    ...
	    <title>Register Advertisement</title>
    ...
    <body>
        <%
            ...
            if(!accessPrivilegeHelper.checkAccessPrivilegesForAdvertisement(loggedAdmin, "create"))
            {
	    ...
	    <div class="container">
	    	...
	    	<div class="main-container">
			    <form action="/Cab_It/validation/advertisement/create-validation.jsp" method="POST">
			     <label for="">Content</label> 
			            <textarea
			                    name="content"
			                    content=<%= session.getAttribute("prev-content") == null ? "" : session.getAttribute("prev-content") %>>
			            </textarea>
