 ...
 * Generated at: 2021-05-20 08:35:03 UTC
...
public final class update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t    <title>Customer Update</title>\r\n");
      ...
      out.write("\t\t    \t<form action=\"/Cab_It/validation/customer/update-validation.jsp\" method=\"POST\">\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t                    name=\"nic\"\r\n");
      out.write("\t\t                    value=");
      out.print( session.getAttribute("prev-nic") == null ? loggedCustomer.getNic() : session.getAttribute("prev-nic") );
      out.write(">\r\n");
      ...
      out.write("\t\t                    value=");
      out.print( session.getAttribute("prev-fname") == null ? loggedCustomer.getFirstName() : session.getAttribute("prev-fname") );
      out.write(">\r\n");
      out.write("\t\t                    <font color=\"red\">\r\n");
      out.write("\t\t                        ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-mname") == null ? loggedCustomer.getMidName() : session.getAttribute("prev-mname") );
      out.write(">\r\n");
      out.write("\t\t        <br>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-lname") == null ? loggedCustomer.getLastName() : session.getAttribute("prev-lname"));
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\" >\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-uname") == null ? loggedCustomer.getUsername() : session.getAttribute("prev-uname"));
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-passwd") == null ? loggedCustomer.getPassword() : session.getAttribute("prev-passwd"));
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-address-1") == null ? loggedCustomer.getAddressLine1() : session.getAttribute("prev-address-1") );
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-address-2") == null ? loggedCustomer.getAddressLine2() : session.getAttribute("prev-address-2") );
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-address-3") == null ? loggedCustomer.getAddressLine3() : session.getAttribute("prev-address-3") );
      out.write(">\r\n");
      out.write("\t\t        <br>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t                name=\"city\"\r\n");
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-city") == null ? loggedCustomer.getCity() : session.getAttribute("prev-city") );
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
      ...
      out.write("\t\t                value=");
      out.print( session.getAttribute("prev-phone") == null ? loggedCustomer.getPhone() : session.getAttribute("prev-phone") );
      out.write(">\r\n");
      out.write("\t\t                <font color=\"red\">\r\n");
      out.write("\t\t                    ");
